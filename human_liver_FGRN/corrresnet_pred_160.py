...
class Classifier_corrResNET_pred:
    ...
    def build_feature_model(self, x_train, nb_classes):
        ...
        output_layer = keras.layers.Dense(160, activation='softmax')(gap_layer)
    ...
    def build_model(self, nb_classes, x_tarin1, x_tarin2,net_emd_tf_s, net_emd_tf_t, net_emd_target_s,net_emd_target_t):
        ...
        fc2 = keras.layers.Dense(160, activation='relu')(fc1)
    ...
    def fit(self, x_train_1,x_train_2, net_emd_tf_s_train, net_emd_tf_t_train, net_emd_target_s_train,net_emd_target_t_train, y_train,
