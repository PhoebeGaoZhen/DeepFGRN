...
if __name__ == '__main__':
    ...
    network_dict_name = 'DREAM5 network3_' + str(dim_net) + '_' + logTime
    ...
    network_dict = {"AUROC mean": 0,
                    ...
                    "Acc mean": 0,
                    "Acc std": 0}
    print('DREAM5 network3 is training............................................................')
    path = '.\\traindataDREAM5\\DREAM5_NetworkInference_GoldStandard_Network3_Ecoli.tsv'
    pathts = '.\\traindataDREAM5\\net3_expression_data.tsv'

    pathnode = '.\\traindataDREAM5\\net3_node.txt'
    output_directory = '.\\output_directory\\DREAM5network3\\'
